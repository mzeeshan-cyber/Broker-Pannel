...
import { ArrowDown2, Camera, Eye, EyeSlash } from 'iconsax-react';
...
export default function AddReimbursementDriver() {
    ...
    const AddReimbursementDriver = async (values, { setSubmitting, setErrors }) => {
        try {
            ...
            setTimeout(() => {
                navigate(`/patients/${patientId.id}/reimbursement-drivers`);
            }, 1500);
                                ...
                                <Box>
                                    ...
                                    <Stack direction="row" sx={{ mt: 1 }}>
                                        ...
                                        <TextField
                                            ...
                                            variant="outlined"
                                            sx={{ display: 'none' }}
                                            onChange={(e) => setLicenseFrontImage(e.target.files?.[0])}
                                        />
                                    </Stack>
                                ...
                                <Box>
                                    ...
                                    <Stack direction="row" sx={{ mt: 1 }}>
                                        ...
                                        <TextField
                                            ...
                                            variant="outlined"
                                            sx={{ display: 'none' }}
                                            onChange={(e) => setLicenseBackImage(e.target.files?.[0])}
                                        />
                                    </Stack>
