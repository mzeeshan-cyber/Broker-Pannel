...
export default function Objections({ data, UpdateObjecion, getDriverDetails, openModal, setOpenModal }) {
    const matchDownMD = useMediaQuery((theme) => theme.breakpoints.down('md'));
    const objectionData = data?.provider_driver_objections;
    ...
    return (
        <Grid container spacing={3}>
            <Grid item xs={12}>
                <Grid container spacing={3}>
                    <Grid item xs={12} >
                        <MainCard title="Driver Objections">
                            ...
                            {modalType === 'verify' &&
                                <ObjectionModal openModal={openModal} setOpenModal={setOpenModal} title={`Verify/Re Objection`}>
                                    <VerifyObjectionModal objectionById={objectionById} UpdateObjecion={UpdateObjecion} setOpenModal={setOpenModal} getDriverDetails={getDriverDetails} />
                                </ObjectionModal>
                            }
                        </MainCard>
                    </Grid>
