...
import Filters from 'components/pages/attendents/filters';
...
function EditAction({ row, table }) {
  ...
  return (
    <Stack direction="row" spacing={1} alignItems="center">
      <Tooltip title='Edit'>
        <IconButton color={'primary'} onClick={() => navigate(`/patients/${patient_id}/attendent/${row?.original.id}/update`)}>
    ...
    <MainCard content={false} sx={{ overflow: 'visible !important' }}>
      ...
      >
        ...
        <Stack direction="row" spacing={2} alignItems="center" sx={{ width: { xs: '100%', sm: 'auto' } }}>
          ...
          <Link to={`/patients/${patient_id}/attendent/add`}>
            <Button
              variant="contained"
              color="primary"
              type='button'
            ...
            >
              <AddCircle size="32" />
              <Box sx={{ marginLeft: '5px' }}>Attendent</Box>
            </Button>
          </Link>

          <Tooltip title='Deleted Reimbursement Driver'>
            <IconButton color={'error'} onClick={() => navigate(`/patients/${patient_id}/attendent/deleted`)}>
              <Trash
                variant="Bold"
              />
            </IconButton>
...
export default function AttendentTable({ handleDelete, handleUpdate, handleGetBySearch, handleChangePagination, handleChange, pageSize, page  }) {
