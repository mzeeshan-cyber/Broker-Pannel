...
export default function PandingRateListTable({ data, handleDelete, handleUpdate, defaultColumns, handleApproveMultiple }) {
    ...
    const assignedData = data.some(u => u.status === 'assigned');
                        ...
                        >
                            ...
                            <Stack direction="row" spacing={2} alignItems="center" sx={{ width: { xs: '100%', sm: 'auto' } }}>
                                {!assignedData &&
                                    ...
                                    >
                                        {`Approve All ${seletedRows.length > 0 ? `(${seletedRows.length})` : ''}`}
                                    </Button>
                                }
                            </Stack>
                        </Stack>
                        <TransitionsModal openModal={openModal} setOpenModal={setOpenModal} title={`Approve rate lists `} handleSubmit={() => handleApproveMultiple(seletedRows, setOpenModal)} btnText='Yes' >
                            <Typography id="modal-modal-description">{`Are you sure, you want to resolve all selected rate lists?`}</Typography>
                        </TransitionsModal>
                    </>
                </Stack>
