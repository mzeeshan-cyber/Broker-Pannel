...
import ApprovedTripTable from 'pages/tables/broker-tables/trips/approvedTripTable';
...
export default function ApprovedTrips() {
  ...
  const getTripsData = async (values) => {
    ...
    try {
      setIsLoading(true);
      const response = await fetcher(["/trips/approved", { params: cleanParams }]);
  ...
  const deleteTrip = async (id) => {
    ...
    const response = await fetcherDelete([`trips/delete/${id}`]);
