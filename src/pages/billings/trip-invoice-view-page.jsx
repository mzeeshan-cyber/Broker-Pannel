...
import CommonTable from './BillingTable';
      ...
      {isLoading ?
        ...
        <>
          <Box display="flex" alignItems="center" gap="10px" mb={1}>
            ...
            <Typography variant='h6'>INV-{new Date().getFullYear()}-{invoice_id}-Invoice</Typography>
          </Box>
          <CommonTable
            ...
            stackontable={<TripButtonsOnTable handleGetData={getTripsInvoices} pageTitle="invoice-view" setRiskData={setRiskData} riskData={riskData}/>}
