...
import { complainstStatus, complaintsPriority } from 'constants/constants';
...
export default function Filters({ handleGetBySearch, filters }) {
    ...
    const handleDeleteFilter = (key) => {
        const updatedFilters = { ...complaintsState.filterValue };
    ...
    return (
        <Box sx={{ flexShrink: 0, ml: 0.75 }}>
            {complaintsState.filterValue &&
                Object.entries(complaintsState.filterValue).map(([key, value]) => {
                                                ...
                                                <Grid container spacing={1} gridColumn={12}>
                                                    <Grid item xs={12}>
                                                        <InputField
                                                            ...
                                                            type="text"
                                                            touched={touched.complaint_number}
                                                            errors={errors.complaint_number}
                                                            values={values.complaint_number}
